        ...
        <div className="container-custom max-w-4xl">
          <div className="prose prose-lg max-w-none">
            <p>
              ...
              carefully before using the A-Team Edventures website ("website",
              "service") operated by A-Team Edventures ("us", "we", "our").
            </p>
            ...
            <p>
              ...
              advised to leave the website accordingly. A-Team Edventures only
            ...
            <p>
              ...
              this website are the property of A-Team Edventures, its
              ...
              will not reproduce or redistribute the A-Team Edventures's
              intellectual property in any way, including electronic, digital,
              or new trademark registrations.
            </p>
            <p>
              You grant A-Team Edventures a royalty-free and non-exclusive
            ...
            <p>
              We reserve all rights to edit or remove content at our sole
              discretion.
            </p>

            <h2 className="text-2xl font-bold mt-8 mb-4">Applicable Law</h2>
            <p>
              By visiting this website, you agree that the laws of Hong Kong,
              ...
              between A-Team Edventures and you, or its business partners and
              associates.
            </p>

            <h2 className="text-2xl font-bold mt-8 mb-4">Disputes</h2>
            <p>
              Any dispute related in any way to your visit to this website shall
              be arbitrated by court in Hong Kong and you consent to exclusive
              jurisdiction and venue of such courts.
            </p>

            <h2 className="text-2xl font-bold mt-8 mb-4">Indemnification</h2>
            <p>
              You agree to indemnify A-Team Edventures and its affiliates and
              hold A-Team Edventures harmless against legal claims and demands
              that may arise from your use or misuse of our services. We reserve
            ...
            <p>
              A-Team Edventures is not liable for any damages that may occur to
              you as a result of your misuse of our website. A-Team Edventures
              reserves the right to edit, modify, and change this Agreement at
              any time. This Agreement is an understanding between A-Team
              Edventures and the user, and this supersedes and replaces all
            ...
            <ul className="list-none space-y-2">
              <li>By email: info@ateamedventures.com</li>
              <li>By phone number: +852 6466 9949</li>
              <li>
                By mail: 33/F, Suite 3319-20, Hing Wai Center, 7 Tin Wan Praya
