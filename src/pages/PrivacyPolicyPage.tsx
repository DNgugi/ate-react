      ...
      <div className="py-16 bg-white">
        <div className="container-custom max-w-4xl">
          <div className="prose prose-lg max-w-none">
            <p>
              A-Team Edventures ("we," "our," or "us") is committed to
              protecting your privacy. This Privacy Policy explains how your
              personal information is collected, used, and disclosed by A-Team
              Edventures.
            </p>
            ...
            <p>
              ...
              our Service, you signify that you have read, understood, and agree
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                "we," "us," or "our," it refers to A-Team Edventures, that is
                responsible for your information under this Privacy Policy.
              </li>
              <li>
                <strong>Country:</strong> where A-Team Edventures or the
                owners/founders of A-Team Edventures are based, in this case is
                Hong Kong.
              </li>
              <li>
                <strong>Customer:</strong> refers to the company, organization
                or person that signs up to use A-Team Edventures Services.
              </li>
              <li>
              ...
              <li>
                <strong>Website:</strong> A-Team Edventure's site, which can be
                accessed via this URL:{" "}
                <a
                  href="https://www.ateamedventures.com/"
                  className="text-primary-600 hover:text-primary-800"
                >
                  www.ateamedventures.com
                </a>
              </li>
              <li>
                <strong>You:</strong> a person or entity that is registered with
                A-Team Edventures to use the Services.
              </li>
            </ul>
            ...
            <p>
              A-Team Edventures follows a standard procedure of using log files.
            ...
            <p>
              Like any other website, A-Team Edventures uses 'cookies'. These
            ...
            <p>
              A-Team Edventure's Privacy Policy does not apply to other
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">
              PDPO/GDPR Data Protection Rights
            </h2>
            <p>
